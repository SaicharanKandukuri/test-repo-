...
cp out/$SUITE-arm64*tar* $SUITE-arm64
cp out/$SUITE-armhf*tar* $SUITE-armhf
cp out/$SUITE-amd64*tar* $SUITE-amd64

sha256sum out/$SUITE-arm64*tar* > $SUITE-arm64/SHA256SUM
sha256sum out/$SUITE-armhf*tar* > $SUITE-arm64/SHA256SUM
sha256sum out/$SUITE-amd64*tar* > $SUITE-arm64/SHA256SUM
